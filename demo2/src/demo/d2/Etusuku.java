...
public class Etusuku {
   ...
   public static String vaihdaEtuSuku(String nimi) {
       if (nimi == "" || nimi == " ") return "";
       if (nimi.indexOf(" ") == -1) return nimi;
       StringBuilder kokoNimi = new StringBuilder(nimi);
       String etunimi = erota(kokoNimi, ' ', true);
       String sukunimi = kokoNimi.toString();
       return (sukunimi + " " + etunimi);
   }
