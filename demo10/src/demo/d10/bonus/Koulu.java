...
public class Koulu {
    ...
    /**
     * Luokka listan alkioille
     * @param <TYPE> tyyppi jota tallennetaan
     */
    public static class ListanAlkio<TYPE> {
        
        private TYPE alkio;
        private ListanAlkio<TYPE> seuraava;
        
        /**
         * Muodostetaan listan alkio
         * @param alkio listaan tallennettava alkio
         */
        public ListanAlkio(TYPE alkio) {
            this.alkio=alkio;
        }
        
        
        /**
         * Palauttaa lisätyn oppilaan
         * @return viite oppilaaseen
         */
        public TYPE annaAlkio() {
            return this.alkio;
        }
        
        
        /**
         * Palautetaan listan alkion tiedot merkkijonona
        ...
        /**
         * Palauttaa seuraavan listassa olevan alkion
         * @return seuraava listassa oleva alkio
         */
        public ListanAlkio<TYPE> annaSeuraava() {
    ...
    /**
     * Luokan josta tehdään oppilaita
     */
    ...
    private ListanAlkio<Oppilas> ensimmainen;
    private ListanAlkio<Oppilas> viimeinen;
    ...
    public void lisaa(Oppilas oppilas) {
        ListanAlkio<Oppilas> uusi = new ListanAlkio<Oppilas>(oppilas);
        if (this.ensimmainen == null ) 
            this.ensimmainen = uusi;       
        else
            this.viimeinen.seuraava = uusi;
        this.viimeinen = uusi;
        this.oppilaita++;
    }
    ...
    /**
     * Palauttaa ensimmäisenä olevan alkion
     * @return listan ensimmäinen oppilas
     */
    public ListanAlkio<Oppilas> annaEka() {
        return this.ensimmainen;
    }
    
    
    /**
     * Saantimetodi viimeisenä olevalle alkiolle
     * @return linkitetyn listan viimeisenä oleva oppilas
     */
    public ListanAlkio<Oppilas> annaVika() {
    ...
    public void tulosta(OutputStream os)  {
        ...
        out.println("==========================================");
        ListanAlkio<Oppilas> kohdalla = this.ensimmainen;
        while (kohdalla != null) {
